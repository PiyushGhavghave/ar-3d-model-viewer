        ...
        <div className="flex min-h-screen w-full flex-col bg-slate-50">
            ...
            <main className="flex-grow container mx-auto p-4 md:p-8 flex items-start justify-center">
                <Card className="w-full max-w-2xl">
                    <CardHeader>
                        <CardTitle>Upload a New 3D Model</CardTitle>
                        <CardDescription>
                            Fill in the details and upload your model file. A thumbnail will
                    ...
                    <CardContent>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="model">3D Model File (.glb, .gltf)</Label>
                                <div className="w-full h-40 bg-slate-100 rounded-md flex flex-col items-center justify-center text-center p-4">
                                    <UploadCloud className="h-10 w-10 text-slate-400" />
                                    {modelFile ? (
                                        <p className="text-sm mt-2 text-slate-600 truncate w-full">
                                            {modelFile.name}
                                        </p>
                                    ) : (
